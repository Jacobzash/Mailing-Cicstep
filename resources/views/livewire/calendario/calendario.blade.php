...
<div class="max-w-full md:max-w-full sm:max-w-full mx-auto md:mx-auto sm:mx-auto  sm:px-6 lg:px-8">
...
<div class="antialiased sans-serif max-w-full md:max-w-full mx-auto md:mx-auto ">
	<div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
		<div class="container mx-auto px-4 py-2 md:py-24">
			...
			<div class="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-full mx-auto sm:px-6 lg:px-10 my-auto">

				<div class="flex items-center justify-between py-10 px-6">
					<div>
				...
				<div class="-mx-1 mb-6 md:mx-auto sm:mx-auto md:p-4 sm:p-4">
					<div class="flex flex-wrap" style="margin-bottom: -40px;">
						<template x-for="(day, index) in DAYS" :key="index">
							<div style="width: 14.26%" class="px-2 py-2">
								<div
									x-text="day"
									class="text-blue-600 text-sm uppercase tracking-wide font-bold text-center"></div>
							</div>
						</template>
					</div>
